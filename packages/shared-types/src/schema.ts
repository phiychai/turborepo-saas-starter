...
export interface BlockMarkdown {
	...
	adas?: string | null;
	asdasd?: 'json' | null;
	gffgjgfj?: string | null;
	fafsf?: string | null;
}

export interface BlockMarkdownUndefined {
	/** @primaryKey */
	id: number;
	block_markdown_id?: number | null;
	item?: string | null;
...
export interface PageBlock {
	...
	date_updated?: string | null;
	user_updated?: DirectusUser | string | null;
	visibility?: 'all' | 'authenticated' | 'anonymous' | null;
}
...
export interface Tag {
	...
	/** @required */
	name: string;
	/** @description Unique slug for tag */
	slug?: string | null;
...
export interface Schema {
	...
	block_markdown_undefined: BlockMarkdownUndefined[];
...
export enum CollectionNames {
	...
	block_markdown_undefined = 'block_markdown_undefined',
