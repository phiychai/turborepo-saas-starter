...
The Spaces & Profile system enables a Substack/Medium-like content organization where users can create multiple "spaces" (collections) to organize their posts. Each user has a public profile page that displays their spaces and recent content.
...
- Space listing pages: `/@username/[spaceSlug]`
