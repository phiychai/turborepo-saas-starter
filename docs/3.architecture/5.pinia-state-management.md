...
- ✅ Persistence support (localStorage/sessionStorage)
...
├── user.ts       # User preferences & profile data
...
**Auth Store:**
- ✅ `user` - User object (persisted)
- ❌ `loading` - Not persisted
- ❌ `initialized` - Not persisted
...
// ⚠️ Works but not ideal for new code
...
```typescript
// ✅ Good - Updates when store changes
const user = computed(() => authStore.user);

// ⚠️ OK for one-time read
...
- ✅ **4 stores**: auth, user, billing, ui
- ✅ **Type-safe**: Full TypeScript support
- ✅ **Persistent**: Survives page reloads
- ✅ **SSR-ready**: Works with Nuxt SSR
- ✅ **DevTools**: Debugging support
- ✅ **Testable**: Easy to unit test
- ✅ **Backward compatible**: `useAuth()` still works
