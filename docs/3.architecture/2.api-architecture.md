...
| `/api/user/profile`                 | Update profile             | PATCH  |
...
- ✅ Can use Directus permissions for basic protection
...
### Public Contact Form
```
Browser → Nuxt Server API → Directus
  POST /api/forms/submit
```

### Authenticated User Form
```
Browser → AdonisJS Gateway → Directus
